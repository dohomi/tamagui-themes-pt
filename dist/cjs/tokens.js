...
var import_colors = require("@tamagui/colors"), import_web = require("@tamagui/web"), import_theme_colors = require("./theme-colors");
const { blue, gray, green, red, yellow, blueDark, grayDark, greenDark, redDark, yellowDark, pinkDark, pink } = import_theme_colors.ptThemeColors, size = {
  $0: 0,
  "$0.25": 2,
  "$0.5": 4,
  "$0.75": 8,
