...
import { ptThemeColors } from "./theme-colors";
const { blue, gray, green, red, yellow, blueDark, grayDark, greenDark, redDark, yellowDark, pinkDark, pink } = ptThemeColors, size = {
  $0: 0,
  "$0.25": 2,
  "$0.5": 4,
  "$0.75": 8,
